...
namespace GreenBehaviors.Composite
{
    ...
    public class Parallel : CompositeNode
    {
        ...
        private readonly NodeState _continueState;
            ...
            params Node[] nodes) : base(name, nodes)
        {
            if ((InstancePolicy = policy) == Policy.Sequence)
            {
                ...
                _continueState = NodeState.Success;
            }
            else
            {
                _returnState = NodeState.Success;
                _continueState = NodeState.Failure;
            }
        ...
        public NodeState JoinTick()
        {
            ...
            return runningNodes.Count > 0 ? NodeState.Running : _returnState;
        }
